...
class Patient1 implements Comparable<Patient> {
...
public class TestPatientList {
	...
	public static void main(String args[]) {
		...
		patientList.add(new Patient(1, "Himanshi", 21));
		patientList.add(new Patient(2, "Komal", 26));
		patientList.add(new Patient(3, "Jatin", 18));
		...
		int age = getPatientAge("Himanshi", listofpatientintreeset);
