...
class ScoreAnalyzer1 {
	...
	public ScoreAnalyzer1() {
		// TODO Auto-generated constructor stub
		super();
	}

	public ScoreAnalyzer1(int runsData) {
		super();
...
public class TestScoreAnalyzer1 {

	public static void main(String args[]) {
		int i;
		ScoreAnalyzer1 analyzer = new ScoreAnalyzer1();
		Scanner sc = new Scanner(System.in);
		System.out.println("Enter Runs ");

		for (i = 0; i < 5; i++) {
			int runInputByPlayer = sc.nextInt();
